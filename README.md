[![Build Status](https://travis-ci.com/hakito/CakePHP-StripePaymentIntents-Plugin.svg?branch=master)](https://travis-ci.com/hakito/CakePHP-StripePaymentIntents-Plugin)
